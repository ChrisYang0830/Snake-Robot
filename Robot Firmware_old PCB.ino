...
void incrementPacketQueue()
{
  ...
  packet_ASCII_hex[i] = Serial.read();
  serialDataHandler();
}
...
{
  Serial.readBytes(packet_ASCII_hex,12);
  byte i;
...
//      }
  ...
  //Serial.print("Xsteering_offset: ");Serial.print(Xsteering_offset);Serial.print('\n');
  //Serial.print("Xsteering_scale: ");Serial.print(Xsteering_scale[2]);Serial.print('\n');
